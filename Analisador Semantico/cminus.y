...
var_declaration     :   INT id SEMI
                    ...
                    ;
fun_declaration     :   INT id LPAREN params RPAREN compound_decl
                        {
                        	$$ = newExpNode(TypeK);
                          $$->type = IntegerK;
                          $$->attr.name = "integer";
                    ...
                    |   VOID id LPAREN params RPAREN compound_decl
                        {
                        	$$ = newExpNode(TypeK);
                          $$->type = VoidK;
                          $$->attr.name = "void";
